...
some unique identifier we may want to to tie with the Approov token to enhance
...
To see the help for how to use the script type from the root of this project:
