...
IMAGE_NAME="${IMAGE_NAME:-approov-quickstart-python-flask}" # default image name for build and run
CONTAINER_NAME="${CONTAINER_NAME:-approov-quickstart-python-flask-app}"
